          ...
          <form className="stack" onSubmit={sendAssistant}>
            ...
            <div className="row">
              ...
              {me.role === 'STUDENT' ? (
                ...
                <span className="small">Type your request here. The queue stays actionable underneath.</span>
              )}
            </div>
            <button>Send</button>
          </form>
        ...
        <section className="card stack">
          <div className="panel-header">
            <div className="stack" style={{ gap: 4 }}>
              ...
              <h3>My Tickets</h3>
              <p className="small">Track status updates and attachments for each request.</p>
            </div>
          </div>
            ...
            <article className="card stack admin-panel">
              <div className="panel-header">
                <div className="stack" style={{ gap: 4 }}>
                  ...
                  <h3>Provision Staff</h3>
                  <p className="small">
                    Create staff accounts and keep admin access aligned with operational needs.
                  </p>
                </div>
              </div>
